...
tools: Grep, Glob, LS, Write, mcp__leann-server__leann_search, mcp__serena__list_dir, mcp__serena__find_file, mcp__serena__search_for_pattern, mcp__serena__get_symbols_overview
model: sonnet
---
